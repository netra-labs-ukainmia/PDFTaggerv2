...
public class TaggingProcessor {
    ...
    private void initializeRootTag() {
    ...
    public int processBlocks(JSONArray blocks) {
        ...
        for (int i = 0; i < blocks.length(); i++) {
            ...
            Rectangle rect = createRectangle(block);
    ...
    private Rectangle createRectangle(JSONObject block) {
    ...
    private void tagBlock(Rectangle rect, String role) {
